...
let DashboardComponent = class DashboardComponent {
    ...
    findlocation(data) {
        this.apiCall.findLocation(data).subscribe((res) => {
            if (res.status == 'false') {
                alert(res.message);
            }
            else {
                this.location = res.result[0].location;
    ...
    createSpareItem(data) {
        console.log(data);
        this.apiCall.create(data).subscribe((res) => {
    ...
    getSpareParts(data) {
        this.apiCall.getSpareParts(data).subscribe((res) => {
            console.log(res);
            if (res.status == 'false') {
                alert(res.message);
            }
    ...
    createBranch(data) {
        this.apiCall.createBranch(data).subscribe((res) => {
            console.log(res);
            alert(res.message);
        });
    }
